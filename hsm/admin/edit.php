                ...
                <div class="col-md-10">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" name="salary" class="form-control" autocomplete="off" placeholder="Enter Salary"
                                value="<?php echo $row['salary']; ?>">
                                <input type="submit" value="Update Salary" name="update" class="btn btn-success my-3">
